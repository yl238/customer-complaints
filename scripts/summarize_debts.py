...
if __name__ == '__main__':
    ...
    subset = df[df.Product == 'Debt collection']
    ...
    with open('../output/debts_sentences.pickle', 'wb') as f:
    ...
    subset.to_csv('../data/debts_with_summaries.csv', index=False)
    ...
    with open('../output/debs_lda_model.pickle', 'wb') as f:
        pickle.dump(data, f, pickle.HIGHEST_PROTOCOL)