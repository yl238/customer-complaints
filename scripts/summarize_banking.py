...
if __name__ == '__main__':
    ...
    subset = df[df.Product == 'Bank account or service']
    ...
    with open('../output/banks_sentences.pickle', 'wb') as f:
    ...
    subset.to_csv('../data/banks_with_summaries.csv', index=False)
    ...
    with open('../output/banks_lda_model.pickle', 'wb') as f:
        pickle.dump(data, f, pickle.HIGHEST_PROTOCOL)