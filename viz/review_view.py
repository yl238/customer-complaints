...
suedat = json.load(open('../example/output/nbs_identified_topics.json','r'))
...
def homepage():
    ...
    htmldata = complaints[complaints.company == 'www.nbs.co.uk'][['company', 'date_time', 'review_title', 'compliant_text_cleaned','score_num']].to_html()
